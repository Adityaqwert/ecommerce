...
<input type="hidden" name="C"value="<?php echo $data['Id']?>">
   <button name="submit" type="submit" class="bg-danger fs-4 fw-bold my-3 form-control text-white">Update</button>
  </div>
</div>
</form>
</div>
   ...
   if(isset($_POST['update'])){
    ...
    include 'config.php';
    mysqli_query($conn, "UPDATE `tblproduct` SET `PName`='$product_name',
    `PPrice`='$product_price',`PImage`='$imppath',`PCategory`='$product_category' WHERE Id = $id ");
